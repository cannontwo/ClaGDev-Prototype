...
public class Statistics {
	...
	public static void init() {
		...
		Type actionType = new TypeToken<HashMap<String, String[]>>() {}.getType();
		//Type altActionType = new TypeToken<HashMap<String, String>>() {}.getType();
		Gson gson = new Gson();
		...
		try {
			...
			reader = new Scanner(new BufferedReader(new FileReader(new File(SlimeGame.basePath + "data//entityactions.json"))));
			if(reader.hasNext()){
				entityActionsList = gson.fromJson(reader.next(), actionType);
				System.out.println(entityActionsList);
			}
			reader.close();
